...
{
    public class FindingCommandHandler : IRequestHandler<CreateFindingCommand, Unit>, IRequestHandler<UpdateFindingCommand, Unit>, IRequestHandler<DeleteFindingCommand, Unit>
    {
